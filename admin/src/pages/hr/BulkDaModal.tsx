...
import type { RoleDaSummary } from '../../domain/hr/leave.types';
        ...
        {!successCount ? (
            ...
            <form onSubmit={handleExecute}>
              ...
              <div style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
                ...
                <button type="submit" className="primary" disabled={saving} style={{ flex: 1, background: '#0284c7', borderColor: '#0284c7' }}>
                  {saving ? 'Updating in D1...' : `Execute Revision (${filteredRoles.length} Roles) ➔`}
                </button>
              </div>
            </form>
          </>
          ...
          <div style={{ textAlign: 'center', padding: '16px 8px' }}>
            ...
            <p style={{ margin: '0 0 18px', fontSize: '13px', color: '#64748b', lineHeight: 1.5 }}>
              Updated <b>{successCount}</b> allowance rate tiers in Cloudflare D1 with the new revision policy.
            </p>
