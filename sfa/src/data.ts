...
export const roles:Role[]=['MR','ASM','RSM','ZSM','NSM','VP','OWNER'];
...
{id:'u4',userId:'admin',empCode:'ADM001',fullName:'System Admin',role:'OWNER',isActive:true,mobile:'',email:'admin@chiku.example',designation:'Administrator',coveringHqIds:[],areaIds:[]}];
