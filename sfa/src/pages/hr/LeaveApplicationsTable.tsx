...
import type { LeaveApplication } from '../../core/domain/hr/leave.types';
...
export function LeaveApplicationsTable({
  ...
  if (loading) {
    return <div style={{ padding: '40px', textAlign: 'center', color: '#64748b' }}>Loading leave applications...</div>;
  }
  ...
  const getApproverName = (app: LeaveApplication) => {
    if (app.approvedByName) return app.approvedByName;
