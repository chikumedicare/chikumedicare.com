...
interface PrimarySalesContextModalProps {
...
export function PrimarySalesContextModal({
  selectedStockistId,
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #f1f5f9', paddingBottom: '14px' }}>
          <div>
            <h3 style={{ margin: 0, fontSize: '17px', fontWeight: 800, color: '#0f172a' }}>
              🛒 Primary Sales Entry — Select Month
            </h3>
            <small style={{ color: '#64748b', fontSize: '12px' }}>
              Select Stockist & Sales Month before entering product quantities
            </small>
          </div>
          <button
            type="button"
        ...
        <div>
          <label style={{ display: 'block', fontSize: '12.5px', fontWeight: 700, color: '#334155', marginBottom: '6px' }}>
            1. Select Stockist / Distributor Firm *
          </label>
          <select
          ...
          <div style={{ marginTop: '8px' }}>
            {isAlreadyEntered ? (
              <div style={{ fontSize: '12px', fontWeight: 800, color: '#0369a1', background: '#e0f2fe', border: '1px solid #bae6fd', padding: '6px 10px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                <span>✅</span> Entry already recorded: <b>{existingUnits?.toLocaleString('en-IN')} Units</b>. Proceeding will load existing quantities for modification.
              </div>
            ) : (
              <div style={{ fontSize: '12px', fontWeight: 700, color: '#059669', background: '#ecfdf5', border: '1px solid #a7f3d0', padding: '6px 10px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                <span>✨</span> Fresh Month: No previous entry found for this month.
              </div>
            )}
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
          ...
          >
            <span>➡️</span> Proceed to Enter Quantities
          </button>
        </div>
      </div>
    </div>
